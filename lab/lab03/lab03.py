...
def double_eights(n: int) -> bool:
    ...
    elif n % 10 == 8 and (n // 10) % 10 == 8 : return True
...
def ten_pairs(n):
    ...
    if n == 0 : return 0
    last,curr = n % 10, n // 10
    return ten_pairs(curr) + count_digit(curr,10 - last)

def count_digit(n, digit)->int:
    ...
    if n == 0: return 0
    last, curr = n % 10, n // 10
    return count_digit(curr, digit) + (last == digit)
